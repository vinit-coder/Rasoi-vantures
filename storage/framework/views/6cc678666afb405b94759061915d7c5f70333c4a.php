...
<?php $__env->startSection('content'); ?>
    <h3 class="page-title"><?php echo app('translator')->get('quickadmin.countries.title'); ?></h3>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country_create')): ?>
    <p>
        <a href="<?php echo e(route('admin.countries.create')); ?>" class="btn btn-success"><?php echo app('translator')->get('quickadmin.qa_add_new'); ?></a>
    ...
    <p>
        <ul class="list-inline">
            <li><a href="<?php echo e(route('admin.countries.index')); ?>" style="<?php echo e(request('show_deleted') == 1 ? '' : 'font-weight: 700'); ?>"><?php echo app('translator')->get('quickadmin.qa_all'); ?></a></li> |
            <li><a href="<?php echo e(route('admin.countries.index')); ?>?show_deleted=1" style="<?php echo e(request('show_deleted') == 1 ? 'font-weight: 700' : ''); ?>"><?php echo app('translator')->get('quickadmin.qa_trash'); ?></a></li>
        </ul>
    </p>
    <?php endif; ?>
            ...
            <table class="table table-bordered table-striped <?php echo e(count($countries) > 0 ? 'datatable' : ''); ?> <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country_delete')): ?> <?php if( request('show_deleted') != 1 ): ?> dt-select <?php endif; ?> <?php endif; ?>">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->get('quickadmin.countries.fields.shortcode'); ?></th>
                        <th><?php echo app('translator')->get('quickadmin.countries.fields.title'); ?></th>
                        <th><?php echo app('translator')->get('quickadmin.countries.fields.name'); ?></th>
                        ...
                        <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-entry-id="<?php echo e($country->id); ?>">
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.countries.show',[$country->id])); ?>" class="btn btn-xs btn-primary"><?php echo app('translator')->get('quickadmin.qa_view'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country_edit')): ?>
                                    <a href="<?php echo e(route('admin.countries.edit',[$country->id])); ?>" class="btn btn-xs btn-info"><?php echo app('translator')->get('quickadmin.qa_edit'); ?></a>
                                    <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('country_delete')): ?>
<?php echo Form::open(array(
                                        'style' => 'display: inline-block;',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/latest-rasoi-banchers/Rasoi_banchers/resources/views/admin/countries/index.blade.php ENDPATH**/ ?>
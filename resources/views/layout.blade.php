                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i>+917007815641</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> vinitkumaryogi2@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                            ...
                            foreach($all_published_category as $v_category){?>                    
                             <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/product_by_category/'.$v_category->id)}}">{{$v_category->name}}</a></h4>
                                </div>
                            </div>

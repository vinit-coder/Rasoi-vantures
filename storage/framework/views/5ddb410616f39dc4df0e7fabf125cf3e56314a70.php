<?php $__env->startSection('content'); ?>
    <h3 class="page-title"><?php echo app('translator')->get('quickadmin.find-room.title'); ?></h3>
    <div class="panel panel-default">
        ...
        <?php if(isset($rooms) && is_null($rooms)): ?>
            <div class="form-group" style="text-align: center">
                <label><?php echo app('translator')->get('quickadmin.find-room.no_rooms_found'); ?></label>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/latest-rasoi-banchers/Rasoi_banchers/resources/views/admin/find_rooms/index.blade.php ENDPATH**/ ?>
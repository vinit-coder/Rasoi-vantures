...
class CustomersController extends Controller
{
    ...
    public function create()
    {
        ...
        $countries = \App\Models\Country::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function show($id)
    {
        ...
        $countries = \App\Models\Country::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$bookings = \App\Models\Booking::where('customer_id', $id)->get();
